# genpark-tree-of-thought-multi-agent-debate-verifier-skill
...
> **GenPark AI Agent Skill** -- Tree-of-thought multi-agent debate verifier & consensus engine (ToT Debate style)
